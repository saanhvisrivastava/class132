...
Original file is located at
    https://colab.research.google.com/drive/19es-8--HR30SWpLpT4RCIvm1lOF-zLn5
"""
...
for index,planet_mass in enumerate(planet_masses):
  temp_list=[
             planet_radiuses[index],planet_mass
...
for i in range(1,11):
  ...
  kmeans.fit(X)
  wcss.append(kmeans.inertia_)#returns the value of wcss from kmeans model
print(wcss)#within cluster sum of square
